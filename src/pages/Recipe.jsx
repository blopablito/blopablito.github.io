...
export default function Recipe() {
  ...
  return (
    <div className="container" style={{ paddingBottom: 40 }}>
      ...
      {/* 1. IMAGEN GRANDE (Fuera del panel) */}
      <div style={{ 
          width: "100%", 
          height: 450, 
          borderRadius: "16px", 
      ...
      {/* 2. INFORMACIÓN CON DOBLE CUADRO (Panel > Panel-inner) */}
      <div className="panel">
        <div className="panel-inner" style={{ padding: 30, color: "black" }}>
          ...
          {/* Grid de Ingredientes e Instrucciones */}
